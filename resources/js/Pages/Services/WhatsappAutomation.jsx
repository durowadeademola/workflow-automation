...
const features = [
    { icon: "🤖", title: "AI Chatbot", description: "Smart responses to common questions, orders, and inquiries — trained on your specific business." },
    { icon: "📋", title: "Order Management", description: "Take and confirm orders automatically with real-time inventory checks and payment collection." },
    { icon: "📅", title: "Booking System", description: "Automated appointment scheduling, confirmations, and reminders via WhatsApp." },
    { icon: "💳", title: "Payment Collection", description: "Send Paystack/Flutterwave payment links directly in conversation and confirm instantly." },
    { icon: "📊", title: "Analytics Dashboard", description: "Track every conversation, conversion, and revenue generated through WhatsApp." },
    { icon: "👥", title: "Team Inbox", description: "Route complex queries to the right human agent with full conversation history." },
];

const steps = [
    { title: "Connect your WhatsApp Business number", description: "We link your existing number to the SmartFlow platform via the official WhatsApp Business API." },
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                                <div>
                                    ...
                                    <p className="text-gray-600 leading-relaxed mb-6">
                                        ...
                                        SmartFlow's WhatsApp Automation transforms your business number into an intelligent
