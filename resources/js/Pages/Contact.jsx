                    ...
                    <div className="lg:col-span-1 space-y-6">
                        <div className="bg-gray-50 rounded-2xl p-6 border border-gray-100">
                            ...
                            <div className="space-y-3 text-sm">
                                <a href="mailto:hello@blueflowautomation.com" className="flex items-center gap-2 text-gray-600 hover:text-blue-700 transition-colors">
                                    <svg className="w-4 h-4 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                                    </svg>
                                    hello@blueflowautomation.com
                                </a>
                                <a href="tel:+2347064706193" className="flex items-center gap-2 text-gray-600 hover:text-blue-700 transition-colors">
                                    <svg className="w-4 h-4 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                                    </svg>
                                    +234 706 470 6193
                                </a>
                                <a href="https://wa.me/2347064706193" target="_blank" rel="noreferrer" className="flex items-center gap-2 text-gray-600 hover:text-blue-700 transition-colors">
                    ...
                    <div className="lg:col-span-2">
                        {status === "success" ? (
                            ...
                            <form onSubmit={handleSubmit} className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 sm:p-8 space-y-5">
                                ...
                                <div>
                                    <label className="text-sm font-medium text-gray-700 mb-1 block">What are you interested in?</label>
                                    <input
                                        type="text"
