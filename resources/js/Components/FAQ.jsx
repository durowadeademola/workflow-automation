...
function FAQItem({ question, answer }) {
    ...
    return (
        <div className="border-b border-gray-100 last:border-0">
            ...
            >
                <span className="font-semibold text-gray-900 text-sm pr-4 group-hover:text-green-700 transition-colors">
                    {question}
                </span>
                <span className={`flex-shrink-0 w-7 h-7 rounded-full border-2 flex items-center justify-center transition-all ${
                    open ? "bg-green-600 border-green-600 rotate-45" : "border-gray-300 group-hover:border-green-500"
                }`}>
            ...
            <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="bg-gray-50 rounded-2xl p-8 text-center border border-gray-100">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                        ...
                        <Link
                            href="/contact"
                            className="inline-flex items-center gap-2 border-2 border-gray-200 text-gray-700 font-semibold px-5 py-2.5 rounded-xl hover:border-green-500 hover:text-green-700 transition-colors text-sm"
                        >
                            Send a Message
                        </Link>
                    </div>
