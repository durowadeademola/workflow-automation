...
const industries = [
    ...
    },
    {
        ...
        metric: { value: "3x", label: "Faster Support" },
    ...
    },
    {
        ...
        metric: { value: "25%", label: "Higher Occupancy" },
    ...
    },
    {
        ...
        metric: { value: "2x", label: "More Qualified Leads" },
    ...
    },
    {
        ...
        metric: { value: "5hrs", label: "Saved Per Week" },
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
                        ...
                        <div className="flex items-center justify-center">
                            <div className="bg-white rounded-2xl shadow-xl p-10 text-center max-w-xs w-full">
                                ...
                                <p className="text-sm text-gray-500">{industry.metricNote}</p>
                            </div>
                        </div>
                    </div>
                </div>
