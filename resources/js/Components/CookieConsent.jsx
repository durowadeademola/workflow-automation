...
export default function CookieConsent() {
    ...
    return (
        <div
            className="fixed bottom-0 inset-x-0 z-[999999] bg-white border-t border-gray-200 shadow-[0_-4px_24px_rgba(0,0,0,0.1)] px-4 py-4 sm:px-6"
            role="dialog"
            ...
            <div className="max-w-5xl mx-auto">
                <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between sm:gap-4">
                    <p className="text-xs sm:text-sm text-gray-600 leading-relaxed">
                        ...
                        <a href="/privacy-policy" className="text-blue-700 font-medium hover:underline">
                            Learn more
                        </a>
                    </p>
                    <div className="flex flex-wrap items-center gap-2 shrink-0">
                        <button
                            ...
                            className="px-3 py-2.5 sm:py-2 text-xs sm:text-sm font-medium text-gray-500 hover:text-gray-800 transition-colors"
                        >
                            Customize
                        </button>
                        <button
                            ...
                            className="flex-1 sm:flex-none px-4 py-2.5 sm:py-2 rounded-lg text-xs sm:text-sm font-semibold text-gray-700 border border-gray-300 hover:border-gray-400 hover:bg-gray-50 transition-colors"
                        >
                            Necessary only
                        </button>
                        <button
                        ...
                        <button
                            ...
                            className="w-8 h-8 shrink-0 flex items-center justify-center rounded-full text-gray-400 hover:text-gray-600 hover:bg-gray-100 transition-colors"
                        >
                ...
                {expanded && (
                    <div className="mt-4 pt-4 border-t border-gray-100 space-y-3.5">
                        <label className="flex items-center justify-between gap-4">
                            <span>
                                <span className="block text-sm font-medium text-gray-800">Necessary</span>
                                <span className="block text-xs text-gray-500">Required for the site and chat widget to work. Always on.</span>
                            </span>
                            <input type="checkbox" checked disabled className="w-4 h-4 rounded border-gray-300 text-blue-600 opacity-60 shrink-0" />
                        </label>
                        <label className="flex items-center justify-between gap-4 cursor-pointer">
                            <span>
                                <span className="block text-sm font-medium text-gray-800">Analytics</span>
                                <span className="block text-xs text-gray-500">Helps us understand how visitors use the site.</span>
                            </span>
                            <input
                                type="checkbox"
                                checked={analytics}
                        ...
                        <label className="flex items-center justify-between gap-4 cursor-pointer">
                            <span>
                                <span className="block text-sm font-medium text-gray-800">Marketing</span>
                                <span className="block text-xs text-gray-500">Used to show more relevant ads.</span>
                            </span>
                            <input
                                type="checkbox"
                                checked={marketing}
